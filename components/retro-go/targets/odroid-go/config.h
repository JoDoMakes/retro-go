...
#define RG_SCREEN_MARGIN_TOP        4
#define RG_SCREEN_MARGIN_BOTTOM     0
#define RG_SCREEN_MARGIN_LEFT       44
#define RG_SCREEN_MARGIN_RIGHT      13
...
#define RG_GAMEPAD_MAP {\
    {RG_KEY_DOWN, GPIO_NUM_27},\
    {RG_KEY_RIGHT, GPIO_NUM_33},\
    {RG_KEY_LEFT, GPIO_NUM_2},\
    {RG_KEY_UP,  GPIO_NUM_13},\
    {RG_KEY_MENU,   RG_GPIO_GAMEPAD_MENU},\
    {RG_KEY_A,      RG_GPIO_GAMEPAD_START},\
    {RG_KEY_B,      RG_GPIO_GAMEPAD_Y_DOWN},\
}
...
// Built-in gamepad
#define RG_GPIO_GAMEPAD_Y_DOWN      GPIO_NUM_36
#define RG_GPIO_GAMEPAD_X_RIGHT     GPIO_NUM_2
#define RG_GPIO_GAMEPAD_X           ADC1_CHANNEL_6 //GPIO_NUM_34
#define RG_GPIO_GAMEPAD_Y           ADC1_CHANNEL_7 //GPIO_NUM_35
...
// Volume control
#define RG_VOLUME_ADC_CHANNEL      ADC1_CHANNEL_4 //GPIO_NUM_32
